...
export function interpolateLngLat(lat1: number, lng1: number, lat2: number, lng2: number, t: number): Coordinate {
  return {
...
export function bboxWithPadding(lat1: number, lng1: number, lat2: number, lng2: number, padMeters: number): BBox {
