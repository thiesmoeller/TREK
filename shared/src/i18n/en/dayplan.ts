...
const dayplan: TranslationStrings = {
  ...
  'dayplan.optimizeDisabled': 'Route optimization is disabled for days with non-optimizable route segments',
  'dayplan.routeMode': 'Route mode',
  'dayplan.routeModeInherit': 'Trip default',
