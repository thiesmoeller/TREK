...
const dayplan: TranslationStrings = {
  ...
  'dayplan.optimizeDisabled': 'Routenoptimierung ist deaktiviert, wenn nicht optimierbare Routensegmente vorkommen',
  'dayplan.routeMode': 'Routenmodus',
  'dayplan.routeModeInherit': 'Reise-Standard',
